...
$Sql = mysql_query("select * from dlil_country where id='$id' AND active='1' limit 1");
...
$content = $Template->tpl_content(''.get_words(319).': <strong>'.$Row['title'].'</strong>', sites_by_country($id));
